...
-- Active ou non Le menu pour tout le monde
...
-- Active ou non la restriction a un groupe ( superadmin, mod ,ect )
...
-- le nom des group peuvent etre totalement changé !

Group = {
    Authorize1 = 'user',
    --Authorize2 = 'mod',
    --Authorize3 = 'admin',
    --Authorize4 = 'superadmin',
    --Authorize5 = '_dev',
}
